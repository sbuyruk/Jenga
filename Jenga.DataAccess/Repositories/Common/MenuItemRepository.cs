...
namespace Jenga.DataAccess.Repositories.Common
{
    ...
    public class MenuItemRepository : Repository<Models.Common.MenuItem>, IMenuItemRepository
    {
        ...
        public async Task<IEnumerable<Models.Common.MenuItem>> GetActiveMenuItemsAsync(CancellationToken cancellationToken = default)
        {
        ...
        public async Task<IEnumerable<Models.Common.MenuItem>> GetMenuItemsWithChildrenAsync(CancellationToken cancellationToken = default)
        {
            await using var db = _dbFactory.CreateDbContext();
            return await db.MenuItem_Table
                .AsNoTracking()
