...
function loadDataTable() {
    dataTable = $('#tblData').DataTable({
        "ajax": {
            "url": "/Admin/ModulTanim/GetAll"
        },
        "columns": [
            { "data": "adi", "width": "25%" },
            { "data": "programAdi", "width": "15%" },
            { "data": "webpartAdi", "width": "15%" },
            { "data": "aciklama", "width": "25%" },
            {
                ...
                "render": function (data) {
                    return `
                        ...
                        <a href="/Admin/ModulTanim/Edit?id=${data}"
                        class="btn btn-primary mx-2"> <i class="bi bi-pencil-square"></i> Düzenle</a>
                        <a onClick=Delete('/Admin/ModulTanim/Delete/${data}')
